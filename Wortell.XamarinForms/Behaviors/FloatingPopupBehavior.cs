...
namespace Wortell.XamarinForms.Behaviors
{
  public class FloatingPopupBehavior : BindableBehaviorBase<View>
  {
    ...
    public static readonly BindableProperty PopupControlProperty =
      BindableProperty.Create(nameof(PopupControl), typeof (IFloatingPopup), typeof (FloatingPopupBehavior),
    ...
    public static readonly BindableProperty MessageTextProperty =
      BindableProperty.Create(nameof(MessageText), typeof (string), typeof (FloatingPopupBehavior),
        default(string));
    ...
    public static readonly BindableProperty DxProperty =
      BindableProperty.Create(nameof(Dx), typeof (int), typeof (FloatingPopupBehavior),
        default(int));
    ...
    public static readonly BindableProperty DyProperty =
      BindableProperty.Create(nameof(Dy), typeof (int), typeof (FloatingPopupBehavior),
        default(int));
